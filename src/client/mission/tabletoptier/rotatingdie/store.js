/* Duplication of dice store for rotating dice */
...
export const dispatchToken = register(({action, data}) => {
  ...
  if (action === actions.spinDice) {
    const toggle = jsonapiCursor(['activemission', 'dicespin']);
    jsonapiCursor(jsonapi => {
      return jsonapi
        .setIn(['activemission', 'dicespin'], !toggle);
    });
  }
});
