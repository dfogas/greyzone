const ends = {
  richandhidden: `
    <p>
      Many years have passed during which you successfully avoided
  ...
  richanddiscovered: `
    <p>
      After a year or so that you quit the business with
  ...
  discovered: `
    <p>
      You attracted too much attention and it wasn't long before someone
      puzzled out the truth of your organization.
    </p>
    <p>
      Perhaps, with a bit of luck, you'll manage to squeeze yourself out of
      tough situation and start somewhere else anew.
    </p>
  `,
  leftinprison: `
    <p>
      ...
      rescue. Next time either don't send your avatar agent on Prison mission, or,
      you know, buy the game.
    </p>
  `,
  killed: `
    <p>
