const MissionDescriptions = {
  afriendininnercircle: `As long as we have Alan's support, we may conduct our
    operation freely.`,
  agentintrouble: `One of your contacts has reached out to you for help. If
    you help her from the tight situation, that she is in, she will join you.`,
  anolddebt: `It's time to pay.`,
  assasination: `(Not implemented)`,
  bankrobbery: `The business seems to be slow, it's time to get money
    in the old-fashioned way.`,
  catchserialkiller: `(Not implemented)`,
  connectionsmap: `The first thing is to know, who talks to whom and what
    are the feelings of the groups towards each other.`,
  demonstrationofpower: `Let's show our 'friends', that we are serious.`,
