const concepts = {
  cryptography: `from tattoed skin of skull, at ancient times, through Leonardo's
  ...
  espionage: `espionage though subject to some romantic views, can be compared to
  ...
  hacking: `originally hacker was a respectable term, describing individual
  ...
  manipulation: `descendants of monkeys and apes, we are apt not only in mimicking behaviours and acts of others,
  ...
  onlineGames: `pinnacle of fun, distributed computer system, shadow side pay2win games`,
  stealth: `to see without beeing seen`,
  WWW: `one of the services enabled by Internet, beginnings date to 1990 and CERN institute
    has hugely overreached its original purpose, education and science, it is ubiquitos, true, but through
